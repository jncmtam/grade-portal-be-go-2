...
SVC_NAME="actions.runner.dath-241-grade-portal-be-go-2.MacBook-Pro-cua-Minh"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (dath-241-grade-portal-be-go-2.MacBook-Pro-cua-Minh)"
